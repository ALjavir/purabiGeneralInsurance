import heroImg from "~/assets/image/page/about/about-hero.jpg"


export default function AboutHero() {
    const path = "Home > About Us";
    const heroTxt = "Securing Your Future with Confidence"
    const dis = "Driven by a vision of trust and reliability, we aim not just to sell policies, but to build lasting relationships with our clients—supporting you through every stage of life."
    return (
    ...
    <div className="relative z-10 w-full  bg-black/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col items-start">
        ...
        <p className="text-white text-sm md:text-xl font-normal leading-relaxed mt-8">{dis}</p>
    </div>
</section>
    )
}
